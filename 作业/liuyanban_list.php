...
<title>交流板</title><link rel="stylesheet" href="css.css" type="text/css">
</head>
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="white" style="border-collapse:collapse">  
  <tr>
    ...
    <td width="497" bgcolor='#EBE2FE'>交流</td>
    <td width="123" align="center" bgcolor="#EBE2FE">回复</td>
    <td width="123" align="center" bgcolor="#EBE2FE">是否加精</td>
...
?></td>
        <td width="65" align="center"><a href="sh.php?id=<?php echo mysql_result($query,$i,id);?>&amp;yuan=<?php echo mysql_result($query,$i,issh);?>&tablename=liuyanban"><?php echo mysql_result($query,$i,issh);?></a></td>
    <td width="106" align="center"><a href="liuyanban_huifu.php?id=<?php echo mysql_result($query,$i,id);?>">回复</a> <a href="del.php?id=<?php
		echo mysql_result($query,$i,"id");
	?>&tablename=liuyanban" onclick="return confirm('真的要删除？')">删除</a> </td>
  </tr>
  	<?php
	}
}
