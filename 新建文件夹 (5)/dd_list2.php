...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="white" style="border-collapse:collapse">  
  <tr>
    ...
    <td width="120" align="center" bgcolor="#EBE2FE">购买时间</td>
	  <td width="120" align="center" bgcolor="#EBE2FE">是否支付</td>
	    <td width="120" align="center" bgcolor="#EBE2FE">认证码</td>
...
?></td>
	 ...
	 <td width="65" align="center"><a href="sh.php?id=<?php echo mysql_result($query,$i,id);?>&amp;yuan=否&tablename=gwc"><?php echo mysql_result($query,$i,issh);?></a></td>
	 
	  <td width="65" align="center"> <?php echo mysql_result($query,$i,ma);?> </td>
...
<p align="center"><a href="dd_list2.php?pagecurrent=1">首页</a>, <a href="dd_list2.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> ,<a href="dd_list2.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a>, <a href="dd_list2.php?pagecurrent=<?php echo $pagecount;?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 </p>
